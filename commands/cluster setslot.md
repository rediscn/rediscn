...
permalink: commands/cluster_setslot.html
...
1. `MIGRATING` subcommand: Set a hash slot in *importing* state.
2. `IMPORTING` subcommand: Set a hash slot in *migrating* state.
