---
layout: index
title: Redis 3.2.2 下载
excerpt: Redis下载中心(Redis download)，下载各种版本的redis，包括最新redis 3.2.2稳定版redis,3.2.2-Beta版本以及win32/64版本
...
<div class='text'>          
   <div class="text">
          ...
          <ul class="download-versions">
            <li>
              ...
              <div class="download-links">
                ...
                <a class="download-link" href="http://download.redis.io/releases/redis-3.2.2.tar.gz">
          ...
          <p>下载，解压，编译:</p>
          <pre><code>$ wget http://download.redis.io/releases/redis-3.2.2.tar.gz
