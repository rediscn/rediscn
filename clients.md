          ...
          <section id='clients'>
            ...
            <table>
              ...
              <tr>
                ...
                <td class='authors'>
                  <a href='https://twitter.com/stephensearles'>
                    <img alt='stephensearles' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/stephensearles' />
                  </a>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class='authors'>
                  <a href='https://twitter.com/ezmobius'>
                    <img alt='ezmobius' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/ezmobius' />
                  </a>
                  <a href='https://twitter.com/soveran'>
                    <img alt='soveran' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/soveran' />
                  </a>
                  <a href='https://twitter.com/djanowski'>
                    <img alt='djanowski' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/djanowski' />
                  </a>
                  <a href='https://twitter.com/pnoordhuis'>
                    <img alt='pnoordhuis' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/pnoordhuis' />
                  </a>
              ...
              <tr>
                ...
                <td>
                  <a class='icon' href='https://github.com/mitsuhiko/redis-rs'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
                ...
                <td class='authors'>
                  <a href='https://twitter.com/mitsuhiko'>
                    <img alt='mitsuhiko' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/mitsuhiko' />
                  </a>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <a class='icon' href='https://github.com/mneumann/rust-redis'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
                ...
                <td class='authors'>
                  <a href='https://twitter.com/mneumann'>
                    <img alt='mneumann' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/mneumann' />
                  </a>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <a class='icon' href='https://github.com/chrisdinn/brando'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
                ...
                <td class='authors'>
                  <a href='https://twitter.com/chrisdinn'>
                    <img alt='chrisdinn' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/chrisdinn' />
                  </a>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <a class='icon' href='https://github.com/twitter/finagle/tree/develop/finagle-redis'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
              ...
              <tr>
                ...
                <td>
                  <a class='icon' href='https://github.com/andreyk0/redis-client-scala-netty'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
              ...
              <tr>
                ...
                <td>
                  <a class='icon' href='https://github.com/etaty/rediscala'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
                ...
                <td class='authors'>
                  <a href='https://twitter.com/etaty'>
                    <img alt='etaty' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/etaty' />
                  </a>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <a class='icon' href='https://github.com/chiradip/RedisClient'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
                ...
                <td class='authors'>
                  <a href='https://twitter.com/chiradip'>
                    <img alt='chiradip' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/chiradip' />
                  </a>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <a class='icon' href='https://github.com/debasishg/scala-redis'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
                  Apparently a fork of the original client from @alejandrocrosa
                </td>
                <td class='authors'>
                  <a href='https://twitter.com/debasishg'>
                    <img alt='debasishg' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/debasishg' />
                  </a>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <a class='icon' href='https://github.com/acrosa/scala-redis'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
                ...
                <td class='authors'>
                  <a href='https://twitter.com/alejandrocrosa'>
                    <img alt='alejandrocrosa' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/alejandrocrosa' />
                  </a>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <a class='icon' href='https://github.com/top10/scala-redis-client'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
                  An idiomatic Scala client that keeps Jedis / Java hidden. Used in production at http://top10.com.
                </td>
                <td class='authors'>
                  <a href='https://twitter.com/thesmith'>
                    <img alt='thesmith' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/thesmith' />
                  </a>
                  <a href='https://twitter.com/heychinaski'>
                    <img alt='heychinaski' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/heychinaski' />
                  </a>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <a class='icon' href='https://github.com/Livestream/scredis'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
                ...
                <td class='authors'>
                  <a href='https://twitter.com/livestream'>
                    <img alt='livestream' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/livestream' />
                  </a>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <a class='icon' href='https://github.com/pk11/sedis'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
                ...
                <td class='authors'>
                  <a href='https://twitter.com/pk11'>
                    <img alt='pk11' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/pk11' />
                  </a>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <a class='icon' href='http://wiki.call-cc.org/eggref/4/redis-client'>
                    <i class='fa fa-home'></i>
                  </a>
                </td>
                <td>
                  <a class='icon' href='https://github.com/carld/redis-client.egg'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
                ...
                <td class='authors'>
                  <a href='https://twitter.com/carld'>
                    <img alt='carld' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/carld' />
                  </a>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <a class='icon' href='http://www.squeaksource.com/Redis.html'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
              ...
              <tr>
                ...
                <td>
                  <a class='icon' href='https://github.com/Farhaddc/Swidis'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
                ...
                <td class='authors'>
                  <a href='https://twitter.com/Farhaddc'>
                    <img alt='Farhaddc' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/Farhaddc' />
                  </a>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <a class='icon' href='https://github.com/gahr/retcl'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
                ...
                <td class='authors'>
                  <a href='https://twitter.com/gahrgahr'>
                    <img alt='gahrgahr' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/gahrgahr' />
                  </a>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <a class='icon' href='https://github.com/antirez/redis/blob/unstable/tests/support/redis.tcl'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
              ...
              <tr>
                ...
                <td>
                  <a class='icon' href='https://github.com/hishamco/vRedis'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
                ...
                <td class='authors'>
                  <a href='https://twitter.com/hishambinateya'>
                    <img alt='hishambinateya' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/hishambinateya' />
                  </a>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <a class='icon' href='https://github.com/carlosabalde/libvmod-redis'>
                    <i class='fa fa-code-fork'></i>
                  </a>
                </td>
                <td class='description'>
                ...
                <td class='authors'>
                  <a href='https://twitter.com/carlosabalde'>
                    <img alt='carlosabalde' class='twitter-avatar' src='//twitter-avatars.herokuapp.com/avatar/carlosabalde' />
                  </a>
                </td>
              </tr>
            </table>
            <h1 style='margin-top:80px'>Higher level libraries and tools</h1>
            <p>
              ...
              <table>
                <tr>
                  ...
                  <td>
                    <a href='https://github.com/resque/resque'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/defunkt'>defunkt</a>
                  </td>
                  <td>
                    Resque is a Redis-backed Ruby library for creating background jobs, placing them on multiple queues, and processing them later. (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/nvie/rq'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/nvie'>nvie</a>
                  </td>
                  <td>
                    Minimalistic Python task queue. Supports only Redis. (Python)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/ask/celery'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/asksol'>asksol</a>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <a href='https://github.com/paulasmuth/fnordmetric'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/paulasmuth'>paulasmuth</a>
                  </td>
                  <td>
                    Redis/ruby-based realtime Event-Tracking app. (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/soveran/ohm'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/soveran'>soveran</a>
                  </td>
                  <td>
                    Object-hash mapping library for Redis. (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/celery/kombu'>Repository</a>
                  </td>
                  <td>
                  </td>
                  <td>
                    Python AMQP Framework with redis support (Python)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/dahlia/sider'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/hongminhee'>hongminhee</a>
                  </td>
                  <td>
                    Python persistent object library based on Redis. (Python)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/nateware/redis-objects'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/nateware'>nateware</a>
                  </td>
                  <td>
                    Map Redis types directly to Ruby objects. (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/iamteem/redisco'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/iamteem'>iamteem</a>
                  </td>
                  <td>
                    Loose implementation of Ohm in Python (see above for Ohm project) - Warning: Not actively maintained at the moment. (Python)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/sripathikrishnan/redis-rdb-tools'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/srithedabbler'>srithedabbler</a>
                  </td>
                  <td>
                    Parse Redis dump.rdb files, Analyze Memory, and Export Data to JSON. (Python)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/pconstr/rdb-parser'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/pconstr'>pconstr</a>
                  </td>
                  <td>
                    node.js asynchronous streaming parser for redis RDB database dumps. (Javascript)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/pconstr/redis-sync'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/pconstr'>pconstr</a>
                  </td>
                  <td>
                    A node.js redis replication slave toolkit (Javascript)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/soveran/ost'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/soveran'>soveran</a>
                  </td>
                  <td>
                    Redis based queues and workers. (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='http://carlhoerberg.github.io/meerkat/'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/carlhoerberg'>carlhoerberg</a>
                  </td>
                  <td>
                    Rack middleware for Server Sent Events with multiple backends. (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/antirez/redis-sampler'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/antirez'>antirez</a>
                  </td>
                  <td>
                    Sample a Redis DB to understand dataset composition. (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/paulasmuth/recommendify'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/paulasmuth'>paulasmuth</a>
                  </td>
                  <td>
                    Ruby/Redis based recommendation engine (collaborative filtering). (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/redis-store/redis-store'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/jodosha'>jodosha</a>
                  </td>
                  <td>
                    Namespaced Rack::Session, Rack::Cache, I18n and cache Redis stores for Ruby web frameworks. (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/steelThread/redmon'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/steel_thread'>steel_thread</a>
                  </td>
                  <td>
                    A web interface for managing redis: cli, admin, and live monitoring. (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/FetLife/rollout'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/jamesgolick'>jamesgolick</a>
                  </td>
                  <td>
                    Conditionally roll out features with redis. (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/nicolasff/webdis'>Repository</a>
                    <a href='http://webd.is/'>Homepage</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/yowgi'>yowgi</a>
                  </td>
                  <td>
                    A Redis HTTP interface with JSON output. (C)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/seatgeek/soulmate'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/seatgeek'>seatgeek</a>
                  </td>
                  <td>
                    Redis-backed service for fast autocompleting. (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/ryanlecompte/redis_failover'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/ryanlecompte'>ryanlecompte</a>
                  </td>
                  <td>
                    Redis Failover is a ZooKeeper-based automatic master/slave failover solution for Ruby. (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/delano/redis-dump'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/solutious'>solutious</a>
                  </td>
                  <td>
                    Backup and restore your Redis data to and from JSON. Warning: alpha code. (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='http://sidekiq.org/'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/mperham'>mperham</a>
                  </td>
                  <td>
                    Simple, efficient message processing for your Rails 3 application. (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='http://www.rsyslog.com/doc/build_from_repo.html'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/taotetek'>taotetek</a>
                  </td>
                  <td>
                    redis output plugin for rsyslog (rsyslog dev, and rsyslog head). (C)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/sneakybeaky/mod_redis'>Repository</a>
                  </td>
                  <td>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <a href='https://github.com/agoragames/leaderboard'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/czarneckid'>czarneckid</a>
                  </td>
                  <td>
                    Leaderboards backed by Redis. (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/nrk/redis-rdb'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/JoL1hAHN'>JoL1hAHN</a>
                  </td>
                  <td>
                    A set of utilities to handle Redis .rdb files with Ruby. (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/slact/lua-ohm'>Repository</a>
                  </td>
                  <td>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <a href='https://github.com/chrisboulton/php-resque'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/surfichris'>surfichris</a>
                  </td>
                  <td>
                    Port of Resque to PHP. (PHP)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/ErikDubbelboer/phpRedisAdmin'>Repository</a>
                  </td>
                  <td>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <a href='https://github.com/stephpy/timeline-bundle'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/stephpy'>stephpy</a>
                  </td>
                  <td>
                    TimelineBundle is a Bundle which works with Symfony 2.* which provides a timeline for a subject as Facebook can do. (PHP)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/lsbardel/python-stdnet'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/lsbardel'>lsbardel</a>
                  </td>
                  <td>
                    Redis data manager with advanced query and search API. (Python)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/bbangert/retools'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/benbangert'>benbangert</a>
                  </td>
                  <td>
                    Caching and locking helper library. (Python)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='http://github.com/chriso/redback'>Repository</a>
                  </td>
                  <td>
                  </td>
                  <td>
                    Higher-level Redis constructs - social graph, full text search, rate limiting, key pairs. (Javascript)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/pconstr/recurrent'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/pconstr'>pconstr</a>
                  </td>
                  <td>
                    A redis-backed manager of recurrent jobs, for node.js (Javascript)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/agoragames/amico'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/czarneckid'>czarneckid</a>
                  </td>
                  <td>
                    Relationships (e.g. friendships) backed by Redis. (Ruby)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/qi4j/qi4j-sdk'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/eskatos'>eskatos</a>
                  </td>
                  <td>
                    Qi4j EntityStore backed by Redis (Java)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/spring-projects/spring-data-redis'>Repository</a>
                    <a href='http://projects.spring.io/spring-data-redis/'>Homepage</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/costinl'>costinl</a>
                  </td>
                  <td>
                    Spring integration for Redis promoting POJO programming, portability and productivity (Java)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/sasanrose/phpredmin'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/sasanrose'>sasanrose</a>
                  </td>
                  <td>
                    Yet another web interface for Redis with multi-server support (PHP)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/bradvoth/redis-tcl'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/bradvoth'>bradvoth</a>
                    <a href='http://twitter.com/antirez'>antirez</a>
                  </td>
                  <td>
                    Tcl library largely copied from the redis test tree, modified for minor bug fixes and expanded pub/sub capabilities (Tcl)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/uglide/RedisDesktopManager'>Repository</a>
                    <a href='http://redisdesktop.com'>Homepage</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/u_glide'>u_glide</a>
                  </td>
                  <td>
                    Cross-platform desktop GUI management tool for Redis (C++)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/fastogt/fastoredis'>Repository</a>
                    <a href='http://fastoredis.com'>Homepage</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/topilski'>topilski</a>
                  </td>
                  <td>
                    Cross-platform Redis, Memcached management tool. (C++)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://pypi.python.org/pypi/nydus'>Repository</a>
                    <a href='https://pypi.python.org/pypi/nydus'>Homepage</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/zeeg'>zeeg</a>
                  </td>
                  <td>
                    Connection clustering and routing for Redis and Python. (Python)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/poying/redis-mount'>Repository</a>
                    <a href='https://github.com/poying/redis-mount'>Homepage</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/poying'>poying</a>
                  </td>
                  <td>
                    redis-mount lets you use Redis as a filesystem. (Go)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/josiahcarlson/rpqueue'>Repository</a>
                    <a href='https://pypi.python.org/pypi/rpqueue'>Homepage</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/josiahcarlson'>josiahcarlson</a>
                  </td>
                  <td>
                    RPQueue offers a prioritized, periodic, and scheduled task system for Python using Redis (Python)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/josiahcarlson/rom'>Repository</a>
                    <a href='https://pypi.python.org/pypi/rom'>Homepage</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/josiahcarlson'>josiahcarlson</a>
                  </td>
                  <td>
                    Redis object mapper for Python using declarative models, with search over numeric, full text, prefix, and suffix indexes (Python)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/adriano-di-giovanni/node-redis-keychain'>Repository</a>
                    <a href='https://github.com/adriano-di-giovanni/node-redis-keychain'>Homepage</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/codecreativity'>codecreativity</a>
                  </td>
                  <td>
                    A Node.js library for streamlining the configuration and maintenance of your Redis namespace (Javascript)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/eugef/phpRedExpert'>Repository</a>
                    <a href='https://github.com/eugef/phpRedExpert'>Homepage</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/EugeneFidelin'>EugeneFidelin</a>
                  </td>
                  <td>
                    phpRedExpert ia simple and powerful web UI for Redis databases and servers management, written in PHP and JavaScript. (PHP)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/hibernate/hibernate-ogm'>Repository</a>
                    <a href='http://hibernate.org/ogm/'>Homepage</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/mp911de'>mp911de</a>
                    <a href='http://twitter.com/gunnarmorling'>gunnarmorling</a>
                  </td>
                  <td>
                    Hibernate OGM is the JPA integration for Redis (Java)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/binarydud/pyres'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/binarydud'>binarydud</a>
                  </td>
                  <td>
                    Python library inspired by Resque for creating background jobs and workers (Python)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/flygoast/Redis-RdbParser'>Repository</a>
                  </td>
                  <td>
                  </td>
                  <td>
                    Redis-RdbParser is a streaming parser for redis RDB database dumps. (Perl)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/percolate/redset'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/percolate'>percolate</a>
                  </td>
                  <td>
                    Simple, generic sorted sets backed by Redis that can be used to coordinate distributed systems. (Python)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/Redsmin/redsmin'>Repository</a>
                    <a href='https://redsmin.com/'>Homepage</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/fgribreau'>fgribreau</a>
                  </td>
                  <td>
                    A fully featured Redis GUI for managing and monitoring redis. (Web)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/stephenmcd/hot-redis'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/stephenmcd'>stephenmcd</a>
                  </td>
                  <td>
                    Higher Order Types for Redis in Python (Python)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/FGRibreau/redistree'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/fgribreau'>fgribreau</a>
                  </td>
                  <td>
                    Load and save Trees to Redis using sets. (Javascript)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/caio/Redis-NaiveBayes'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/caio'>caio</a>
                  </td>
                  <td>
                    A generic Redis-backed NaiveBayes implementation (Perl)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/wingify/agentredrabbit'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/wingify'>wingify</a>
                  </td>
                  <td>
                    Transport agent that moves data from Redis to RabbitMQ (Python)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/redtrine/redtrine'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/redtrine'>redtrine</a>
                  </td>
                  <td>
                    Redis-based advanced PHP data structures (PHP)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/Redsmin/redis-lua-unit'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/redsmin'>redsmin</a>
                  </td>
                  <td>
                    Framework agnostic unit-testing for Redis Lua scripts (Lua)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/FGRibreau/node-redis-info'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/fgribreau'>fgribreau</a>
                  </td>
                  <td>
                    Redis info string parser for NodeJS (Javascript)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/FGRibreau/redis-tool'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/fgribreau'>fgribreau</a>
                  </td>
                  <td>
                    Redis-tool - Little helpers for Redis (ztrim, del-all, rename) (Javascript)
                  </td>
                </tr>
                <tr>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <a href='https://decibel.ni.com/content/docs/DOC-36322'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/iwac'>iwac</a>
                  </td>
                  <td>
                    LabVIEW toolkit for Redis (LabVIEW)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/cinience/RedisStudio'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/cinience'>cinience</a>
                  </td>
                  <td>
                    Redis GUI tool for windows platform. (C++)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='http://protonail.com/products/keylord'>Homepage</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/protonail'>protonail</a>
                  </td>
                  <td>
                    Cross-platform administration and development GUI application for key-value databases like Redis, LevelDB, etc. (Java)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/no13bus/redispapa'>Repository</a>
                    <a href='https://github.com/no13bus/redispapa'>Homepage</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/no13bus'>no13bus</a>
                  </td>
                  <td>
                    RedisPAPA is a redis monitor which watch the redis-info by using flask, angular, socket.io (Python)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/HangfireIO/Hangfire'>Repository</a>
                    <a href='http://hangfire.io'>Homepage</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/odinserj'>odinserj</a>
                  </td>
                  <td>
                    An easy way to perform fire-and-forget, delayed and recurring tasks inside ASP.NET apps (C#)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/zhengshuxin/acl/tree/master/app/redis_tools/redis_builder'>Repository</a>
                    <a href='https://github.com/zhengshuxin/acl/tree/master/app/redis_tools/redis_builder'>Homepage</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/zhengshuxin'>zhengshuxin</a>
                  </td>
                  <td>
                    A C++ redis tool to create and manage a redis cluster, basing on acl redis lib in https://github.com/zhengshuxin/acl/tree/master/lib_acl_cpp/samples/redis (C++)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/coleifer/huey'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/coleifer'>coleifer</a>
                  </td>
                  <td>
                    Simple multi-threaded Python task queue. Supports Redis. (Python)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/coleifer/walrus'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/coleifer'>coleifer</a>
                  </td>
                  <td>
                    A collection of lightweight utilities for working with Redis in Python. Includes ORM, autocompletion, full-text search, cache, locks, and more. (Python)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/jacket-code/redisPlatform'>Repository</a>
                    <a href='http://www.jacketzhong.com/?p=220'>Homepage</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/jacketzhong'>jacketzhong</a>
                  </td>
                  <td>
                    A rpc platform that base on redis, You can use it to do a lot of things, it can be a game server (C)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/ienaga/RedisPlugin'>Repository</a>
                  </td>
                  <td>
                    <a href='http://twitter.com/ienagatoshiyuki'>ienagatoshiyuki</a>
                  </td>
                  <td>
                    RedisPlugin for Phalcon (The correspondence of MySQL sharding.) (PHP)
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href='https://github.com/maxbrieiev/promise-redis'>Repository</a>
                  </td>
                  <td>
                  </td>
                  <td>
                    Use any promise library with node_redis. (Javascript)
                  </td>
                </tr>
              </table>
            </p>
